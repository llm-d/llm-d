...
```bash
kubectl port-forward -n ${NAMESPACE} svc/optimized-baseline-scheduler-epp 8000:8081
```
...
kustomize build guides/optimized-baseline/modelserver/gpu/vllm/ | kubectl delete -n ${NAMESPACE} -f -
```
