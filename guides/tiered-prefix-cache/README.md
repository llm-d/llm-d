...
```bash
export STORAGE_CLASS="" # cluster default if empty; or e.g. "lustre-class" / "efs-sc" / "azurelustre-class"
...
| ------- | ------------ | ----- |
| GCP Lustre (GKE) | `lustre-class` | [GCP Lustre guide](./manifests/backends/lustre/README.md) |
| AWS EFS | `efs-sc` | [EFS guide](./manifests/backends/aws/README.md) |
| Azure Managed Lustre (AKS) | `azurelustre-class` | [Azure Managed Lustre guide](./manifests/backends/azure/README.md) |
