...
Workload-centric guides — each provides the recommended, cohesive deployment for serving a workload, composing the capability guides above. See the [workloads narratives](../docs/workloads/README.md) for overviews.
