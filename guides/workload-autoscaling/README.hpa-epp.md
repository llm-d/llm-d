...
- **Metric Collection:** For details on how to ensure scraping is active, see the [EPP Metrics guide](../../docs/production-operations/observability/metrics.md#step-3-enable-epp-metrics).
