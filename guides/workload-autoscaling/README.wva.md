...
1. Installed the [optimized-baseline well-lit path guide](../optimized-baseline/README.md).
    ...
    > [!NOTE]
    > WVA requires HTTPS connections to Prometheus for metric collection. When installing the [monitoring stack](../../docs/production-operations/observability/setup.md), ensure to enable HTTPS/TLS support.
