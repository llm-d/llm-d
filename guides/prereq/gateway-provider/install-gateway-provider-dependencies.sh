...
GATEWAY_API_CRD_REVISION=${GATEWAY_API_CRD_REVISION:-"v1.5.0"}
...
GATEWAY_API_INFERENCE_EXTENSION_CRD_REVISION=${GATEWAY_API_INFERENCE_EXTENSION_CRD_REVISION:-"v1.4.0-rc.3"}
