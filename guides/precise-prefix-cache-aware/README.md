...
- Have the [proper client tools installed on your local system](../../helpers/client-setup/README.md), plus a standalone `kustomize` binary (v5+) on `$PATH` for the post-renderer.
