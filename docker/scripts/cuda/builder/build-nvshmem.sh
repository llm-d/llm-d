...
if [ "${BUILD_DEBUG}" = "true" ]; then
    echo "=== Building NVSHMEM with debug logging enabled ==="
    # Use Release build type to avoid stricter compiler warnings from RelWithDebInfo
    # but still enable NVSHMEM debug logging features
    DEBUG_FLAGS=(
