...
- [Predicted Latency Well-Lit Path](../../guides/intelligent-inference-scheduling/predicted-latency.md) — how to adopt this path: Helm enablement, request headers, verification, troubleshooting.
