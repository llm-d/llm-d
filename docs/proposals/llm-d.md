...
2. **vLLM model servers** deployed onto Kubernetes
    1. In single-host or multi-host (using [LeaderWorkerSets](https://lws.sigs.k8s.io/) and [Ray](https://docs.vllm.ai/en/latest/serving/parallelism_scaling/#multi-node-deployment) configurations
