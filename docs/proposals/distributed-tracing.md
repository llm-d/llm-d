...
> [Distributed Tracing](../production-operations/observability/tracing.md). See also
> [Metrics](../production-operations/observability/metrics.md) for the companion metrics
