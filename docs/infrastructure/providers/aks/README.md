...
| H200      | [Standard_ND96isr_H200_v5](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/nd-h200-v5-series?tabs=sizebasic)  | 8         | 141 GB         | 1128 GB          | ✅                           | [optimized baseline](../../../../guides/optimized-baseline/README.md)<br/>[Precise Prefix Cache Routing](../../../../guides/precise-prefix-cache-routing/README.md)<br/>[P/D Disaggregation](../../../../guides/pd-disaggregation/README.md) (2 nodes required)<br/>[Wide Expert Parallelism (EP/DP) with LeaderWorkerSet](../../../../guides/wide-ep/README-lws.md) (4 nodes required)|

## Cluster Configuration

GPUDirect RDMA is essential for achieving optimal performance with advanced deployment patterns such as [P/D Disaggregation](../../../../guides/pd-disaggregation/README.md) and [Wide Expert Parallelism](../../../../guides/wide-ep/README.md). To enable GPUDirect RDMA, you must create and configure a GPU node pool with the appropriate VM size and install the required drivers.
