...
* [Envoy AI Gateway](./envoy-ai-gateway.md) - Envoy AI Gateway extends Envoy Gateway to handle request traffic to Generative AI services, supporting both egress to external AI providers and ingress to self-hosted model servers through the Gateway API Inference Extension. [Official Envoy AI Gateway docs](https://aigateway.envoyproxy.io/).
