...
**Release snapshot:** [`v0.9.0-rc.2`](https://github.com/llm-d/llm-d/releases/tag/v0.9.0-rc.2)
...
| [Fast Model Actuation (FMA)](../guides/fast-model-actuation/README.md) | [![vLLM GPU](https://img.shields.io/badge/vLLM_GPU-guide--error-red)](https://github.com/llm-d/llm-d/actions/workflows/nightly-e2e-fast-model-actuation-ibm-acc-gpu-vllm-x.yaml) |  |  |  |  |
<!-- RELEASE-MATRIX-END -->
