...
RUNS = [
    ("k8",                        "reasoning-3turn-infperf-baseline-det-2-safe",          "#1f77b4", "o"),
    ("epp kv-scorer",      "reasoning-3turn-infperf-epp-penalty6k-kv-scorer-max-picker-no-exp-det-2-safe", "#d62728", "x"),
    ("epp run-req",      "reasoning-3turn-infperf-epp-penalty6k-req-scorer-max-picker-no-exp-det-2-safe", "#ff7f0e", "x"),
    ("epp default",            "reasoning-3turn-infperf-epp-max-score-det-2-safe", "#2ca02c", "x"),
    ("latency-predictor",  "reasoning-3turn-infperf-epp-penalty5s-latency-predictor-det-4-safe", "#9467bd", "x"),
]
