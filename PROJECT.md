...
Project leadership and maintainer roles are listed in the [MAINTAINERS](./MAINTAINERS) file of this repository. The initial project maintainers are Carlos Costa, Clayton Coleman, and Robert Shaw, representing inference optimization research, the inference gateway project, and vLLM respectively.
